...
// MVP – Registration V2 routes //



// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/sign-in-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/sign-in-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/account-type-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/account-type-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/uk-org-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/uk-org-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/companies-house-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/companies-house-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/who-2-represent-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/who-2-represent-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/added-inter-confirm-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/added-inter-confirm-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S1/WR1/added-team-confirmation-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S1/WR1/added-team-confirmation-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S3/WR2/who-2-represent-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S3/WR2/who-2-represent-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S3/WR1/waste-movements-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S3/WR1/waste-movements-answer', function (req, res) {
  ...
  if (wasteMovements == "api-code") {
    ...
    res.redirect('/layouts/Private-beta/MVP-Registration/V2/S3/WR1/spreadsheet-update')
  }

})

// Run this code when a form is submitted to '/layouts/Private-beta/MVP-Registration/V2/S3/WR2/waste-movements-answer'
router.post('/layouts/Private-beta/MVP-Registration/V2/S3/WR2/waste-movements-answer', function (req, res) {
  ...
  if (wasteMovements == "api-code") {
    ...
    res.redirect('/layouts/Private-beta/MVP-Registration/V2/S3/WR2/spreadsheet-update')
  }
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/permit-uk-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/permit-uk-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/sign-in-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/sign-in-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/account-type-answer''
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/account-type-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/uk-org-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/uk-org-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/companies-house-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/companies-house-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S2/WR1/who-2-represent-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR1/who-2-represent-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S2/WR2/account-type-answer''
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR2/account-type-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/uk-org-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR2/uk-org-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S2/WR2/companies-house-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR2/companies-house-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S2/WR1/waste-movements-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR1/waste-movements-answer', function (req, res) {
  ...
  if (wasteMovements == "api-code") {
    ...
    res.redirect('/layouts/Private-beta/Assessment-journey/V1/S2/WR1/spreadsheet-update')
  }

})


// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S1/WR1/who-2-represent-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S1/WR1/who-2-represent-answer', function (req, res) {
...
// Run this code when a form is submitted to '/layouts/Private-beta/Assessment-journey/V1/S2/WR2/waste-movements-answer'
router.post('/layouts/Private-beta/Assessment-journey/V1/S2/WR2/waste-movements-answer', function (req, res) {
  ...
  if (wasteMovements == "api-code") {
    ...
    res.redirect('/layouts/Private-beta/Assessment-journey/V1/S2/WR2/spreadsheet-update')
  }
...
// Run this code when a form is submitted to '/layouts/Collections/Alpha/Registration/V1/S1/WR1/what-bus-or-org-answer'
router.post('/layouts/Collections/Alpha/Registration/V1/S1/WR1/what-bus-or-org-answer', function (req, res) {
...
// Include new weighbridge router file
